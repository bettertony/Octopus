...
/* Octopus streaming hypothetical-set aggregates */
...
/* Octopus streaming ordered-set aggregates */
...
/* Octopus combiner stuff, heavily inspired by Postgres-XC coordinator aggregation */
...
DATA(insert OID = 4378 ( octopus_views PGNSP PGUID 12 1 20 0 0 f f f f t t s 0 0 2249 "" "{26,25,25,16,25}" "{o,o,o,o,o}" "{id,schema,name,active,query}" _null_ _null_ octopus_views _null_ _null_ _null_ ));
DESCR("get continuous views");

DATA(insert OID = 4379 ( octopus_streams PGNSP PGUID 12 1 20 0 0 f f f f t t s 0 0 2249 "" "{25,25,1009}" "{o,o,o}" "{schema,name,queries}" _null_ _null_ octopus_streams _null_ _null_ _null_ ));
DESCR("get streams");
...
DATA(insert OID = 4389 ( octopus_stat_get PGNSP PGUID 12 1 1 0 0 f f f f t t s 0 0 2249 "" "{25,1184,20,20,20,20,20,20,20,20,20,20}" "{o,o,o,o,o,o,o,o,o,o,o,o}" "{type,start_time,input_rows,output_rows,updated_rows,input_bytes,output_bytes,updated_bytes,executions,errors,cv_create,cv_drop}" _null_ _null_ octopus_stat_get _null_ _null_ _null_ ));
DESCR("global octopus status");

DATA(insert OID = 4390 ( octopus_get_overlay_viewdef	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 25 "25" _null_ _null_ _null_ _null_ _null_ octopus_get_overlay_viewdef _null_ _null_ _null_ ));
DESCR("gets a materialization table overlay view");

DATA(insert OID = 4391 ( octopus_version		   PGNSP PGUID 12 1 0 0 0 f f f f t f s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ octopus_version _null_ _null_ _null_ ));
DESCR("Octopus version string");
...
DATA(insert OID = 4409 ( octopus_get_worker_querydef	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 25 "25" _null_ _null_ _null_ _null_ _null_ octopus_get_worker_querydef _null_ _null_ _null_ ));
DESCR("gets query run by continuous query worker");
DATA(insert OID = 4410 ( octopus_get_combiner_querydef	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 25 "25" _null_ _null_ _null_ _null_ _null_ octopus_get_combiner_querydef _null_ _null_ _null_ ));
...
DATA(insert OID = 4475 ( octopus_combine_table	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 2 0 16 "25 25" _null_ _null_ _null_ _null_ _null_ octopus_combine_table _null_ _null_ _null_ ));
...
DATA(insert OID = 4479 ( octopus_transforms PGNSP PGUID 12 1 20 0 0 f f f f t t s 0 0 2249 "" "{26,25,25,16,25,1009,25}" "{o,o,o,o,o,o,o}" "{id,schema,name,active,tgfn,tgargs,query}" _null_ _null_ octopus_transforms _null_ _null_ _null_ ));
DESCR("get continuous transforms");
DATA(insert OID = 4480 ( octopus_stream_insert	PGNSP PGUID 12 1 0 0 0 f f f f t f v 0 0 2279 "" _null_ _null_ _null_ _null_ _null_ octopus_stream_insert _null_ _null_ _null_ ));
...
DATA(insert OID = 4493 ( octopus_flush	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 0 0 16 "" _null_ _null_ _null_ _null_ _null_ octopus_flush _null_ _null_ _null_ ));
...
DESCR("for use by octopus-upgrade");
