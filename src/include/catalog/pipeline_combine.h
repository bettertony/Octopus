 ...
 *
 * octopus_combine.h
 *		Definition of the octopus_combine catalog table, which contains
 ...
 *		time. See src/gis/postgis/octopus_gis.sql.in for examples.
 *
 * Copyright (c) 2013-2015, Octopus
 *
 * src/include/catalog/octopus_combine.h
 *
 *-------------------------------------------------------------------------
 */
...
/* ----------------------------------------------------------------
 *
 * The octopus_combine catalog table specifies functions that are chained
 * together to form an aggregation combination octopus. "combine" in this
 ...
 * the internal transition state. octopus_combine also provides a way to
 * specify these serialization/deserialization functions.
 *
 * The basic flow of a combination octopus from workers to combiners is
 * as follows,
 *
 * worker:
 *
...
CATALOG(octopus_combine,4247)
{
	...
	regproc combinefn;
	Oid transouttype;
} FormData_octopus_combine;

typedef FormData_octopus_combine *Form_octopus_combine;

#define COMBINE_OID 4300
#define IS_COMBINE_AGG(oid) (oid == COMBINE_OID)

#define Natts_octopus_combine					6
#define Anum_octopus_combine_aggfinalfn		1
#define Anum_octopus_combine_transfn 			2
#define Anum_octopus_combine_transoutfn 		3
#define Anum_octopus_combine_combineinfn 		4
#define Anum_octopus_combine_combinefn 		5
#define Anum_octopus_combine_transouttype 		6
