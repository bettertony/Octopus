...
DECLARE_UNIQUE_INDEX(octopus_query_relid_index, 4243, on octopus_query using btree(relid oid_ops));
#define PipelineQueryRelIdIndexId					4243

DECLARE_UNIQUE_INDEX(octopus_query_id_index, 4241, on octopus_query using btree(id int4_ops));
#define PipelineQueryIdIndexId					4241

DECLARE_UNIQUE_INDEX(octopus_query_oid_index, 4253, on octopus_query using btree(oid oid_ops));
#define PipelineQueryOidIndexId  4253

DECLARE_UNIQUE_INDEX(octopus_query_matrelid_index, 4255, on octopus_query using btree(matrelid oid_ops));
#define PipelineQueryMatRelIdIndexId					4255

DECLARE_UNIQUE_INDEX(octopus_combine_transfn_index, 4248, on octopus_combine using btree(aggfinalfn oid_ops, transfn oid_ops));
#define PipelineCombineTransIdIndexId					4248

DECLARE_UNIQUE_INDEX(octopus_stream_relid_index, 4250, on octopus_stream using btree(relid oid_ops));
#define PipelineStreamRelIdIndexId					4250

DECLARE_UNIQUE_INDEX(octopus_stream_oid_index, 4254, on octopus_stream using btree(oid oid_ops));
#define PipelineStreamOidIndexId  4254

DECLARE_UNIQUE_INDEX(octopus_combine_oid_index, 4256, on octopus_combine using btree(oid oid_ops));
