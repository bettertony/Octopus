...
def test_prepared_extended(octopus, clean_db):
  """
  ...
  rows = list(octopus.execute('SELECT x, y, z FROM test_prepared_extended'))
  assert len(rows) == 1
