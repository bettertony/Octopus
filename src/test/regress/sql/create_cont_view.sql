...
SELECT COUNT(*) FROM octopus_views() WHERE name = 'cqcreate0';
\d+ cqcreate0;
\d+ cqcreate0_mrel;
\d+ cqcreate0_osrel;
SELECT octopus_get_overlay_viewdef('cqcreate0');

CREATE CONTINUOUS VIEW cqcreate1 AS SELECT substring(url, 1, 2) FROM create_cont_stream;
SELECT COUNT(*) FROM octopus_views() WHERE name = 'cqcreate1';
\d+ cqcreate1;
\d+ cqcreate1_mrel;
\d+ cqcreate1_osrel;
SELECT octopus_get_overlay_viewdef('cqcreate1');

CREATE CONTINUOUS VIEW cqcreate2 AS SELECT key, substring(value, 1, 2) AS s FROM create_cont_stream;
SELECT COUNT(*) FROM octopus_views() WHERE name = 'cqcreate2';
\d+ cqcreate2;
\d+ cqcreate2_mrel;
\d+ cqcreate2_osrel;
SELECT octopus_get_overlay_viewdef('cqcreate2');
...
SELECT COUNT(*) FROM octopus_views() WHERE name = 'cqcreate3';
\d+ cqcreate3;
\d+ cqcreate3_mrel;
\d+ cqcreate3_osrel;
SELECT octopus_get_overlay_viewdef('cqcreate3');

CREATE CONTINUOUS VIEW cqcreate4 AS SELECT COUNT(*), SUM(value) FROM create_cont_stream GROUP BY key;
SELECT COUNT(*) FROM octopus_views() WHERE name = 'cqcreate4';
\d+ cqcreate4;
\d+ cqcreate4_mrel;
\d+ cqcreate4_osrel;
SELECT octopus_get_overlay_viewdef('cqcreate4');
...
SELECT COUNT(*) FROM octopus_views() WHERE name = 'cqcreate5';
\d+ cqcreate5;
\d+ cqcreate5_mrel;
\d+ cqcreate5_osrel;
SELECT octopus_get_overlay_viewdef('cqcreate5');
...
SELECT COUNT(*) FROM octopus_views() WHERE name = 'cqcreate6';
\d+ cqcreate6;
\d+ cqcreate6_mrel;
\d+ cqcreate6_osrel;
SELECT octopus_get_overlay_viewdef('cqcreate6');
...
SELECT octopus_get_overlay_viewdef('multigroupindex');
