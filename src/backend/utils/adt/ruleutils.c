...
/*
 * octopus_get_overlay_viewdef
 *
 * Returns all view definitions for all continuous views
 */
Datum
octopus_get_overlay_viewdef(PG_FUNCTION_ARGS)
{
...
/*
 * octopus_get_worker_querydef
 */
Datum
octopus_get_worker_querydef(PG_FUNCTION_ARGS)
{
	/* qualified name continuous view name */
	text *name = PG_GETARG_TEXT_P(0);
	RangeVar *rv;
...
/*
 * octopus_get_combiner_querydef
 */
Datum
octopus_get_combiner_querydef(PG_FUNCTION_ARGS)
{
	/* qualified name continuous view name */
	text *name = PG_GETARG_TEXT_P(0);
	RangeVar *rv;
