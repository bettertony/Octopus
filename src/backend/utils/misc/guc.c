...
#define CONFIG_FILENAME "octopus.conf"
...
static struct config_string ConfigureNamesString[] =
{
...

	{
		{"syslog_ident", PGC_SIGHUP, LOGGING_WHERE,
			gettext_noop("Sets the program name used to identify Octopus "
						 "messages in syslog."),
			NULL
		},
		&syslog_ident_str,
...

	{
		{"event_source", PGC_POSTMASTER, LOGGING_WHERE,
			gettext_noop("Sets the application name used to identify "
						 "Octopus messages in the event log."),
			NULL
		},
		&event_source,
...
{
#ifdef HAVE_SYSLOG
	set_syslog_parameters(syslog_ident_str ? syslog_ident_str : "octopus",
						  newval);
#endif
