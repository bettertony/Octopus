 ...
 *
 * IDENTIFICATION
 *    src/include/octopus/combiner.c
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
#include "pgstat.h"
#include "octopus/combiner_receiver.h"
#include "octopus/analyzer.h"
#include "octopus/planner.h"
#include "octopus/physical_group_lookup.h"
...
Datum
octopus_combine_table(PG_FUNCTION_ARGS)
{
	...
	base->query = cv;
	base->state_cxt = CurrentMemoryContext;
	base->tmp_cxt = AllocSetContextCreate(CurrentMemoryContext, "octopus_combine_table temp cxt",
			ALLOCSET_DEFAULT_MINSIZE,
			ALLOCSET_DEFAULT_INITSIZE,
			ALLOCSET_DEFAULT_MAXSIZE);
