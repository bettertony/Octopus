 ...
 *
 * syscache.c
 *	  Octopus system cache management routines
 *
 * Portions Copyright (c) 1996-2015, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 * Portions Copyright (c) 2017, Octopus
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
static const struct cachedesc cacheinfo[] = {
	{"octopus_combine", "octopus_combine_oid_index",
		1,
		{
	...
	{"octopus_combine", "octopus_combine_transfn_index",
		2,
		{
			Anum_octopus_combine_aggfinalfn,
			Anum_octopus_combine_transfn,
			0,
			0
		},
		2048
	},
	{"octopus_query", "octopus_query_id_index",
		1,
		{
			Anum_octopus_query_id,
			0,
			0,
			0
		},
	...
	{"octopus_query", "octopus_query_relid_index",
		1,
		{
			Anum_octopus_query_relid,
			0,
			0,
			0
		},
	...
	{"octopus_query", "octopus_query_matrelid_index",
		1,
		{
				Anum_octopus_query_matrelid,
			0,
			0,
			0
		},
	...
	{"octopus_query", "octopus_query_oid_index",
		1,
		{
			ObjectIdAttributeNumber,
			0,
	...
	{"octopus_stream", "octopus_stream_relid_index",
		1,
		{
			Anum_octopus_stream_relid,
			0,
			0,
			0
		},
	...
	{"octopus_stream", "octopus_stream_oid_index",
		1,
		{
			ObjectIdAttributeNumber,
			0,
...
InitPipelineSysCache(void)
{
	 ...
	 */
	PipelineCombineRelationOid = get_relname_relid("octopus_combine", PG_CATALOG_NAMESPACE);
	PipelineQueryRelationOid = get_relname_relid("octopus_query", PG_CATALOG_NAMESPACE);
	PipelineStreamRelationOid = get_relname_relid("octopus_stream", PG_CATALOG_NAMESPACE);
	PipelineExecLockRelationOid = get_relname_relid("_octopus_exec_lock", PG_CATALOG_NAMESPACE);
}
