...
check_bin_dir(ClusterInfo *cluster)
{
	...
	validate_exec(cluster->bindir, "octopus");
	validate_exec(cluster->bindir, "octopus-ctl");
	validate_exec(cluster->bindir, "pg_resetxlog");
	if (cluster == &new_cluster)
	{
		/* these are only needed in the new cluster */
		validate_exec(cluster->bindir, "octopus");
		validate_exec(cluster->bindir, "octopus-dump");
		validate_exec(cluster->bindir, "octopus-dumpall");
	}
}
