...
"$oldbindir"/octopus-ctl start -l "$logdir/postmaster1.log" -o "$POSTMASTER_OPTS" -w
...
"$oldbindir"/octopus-ctl -m fast stop
...
octopus-ctl start -l "$logdir/postmaster2.log" -o "$POSTMASTER_OPTS" -w
